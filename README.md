...
Digunakan untuk simulasi prediksi melalui form sederhana.
User dapat memasukkan total income dan pengeluaran per kategori, lalu sistem akan menghitung fitur yang dibutuhkan model secara otomatis.
